...
def main() -> None:
    ...
    # Strong-core rendering is intentionally separate from precipitation
    # detection/motion logic, so all existing filtering and arrows stay intact.
    latest_strong_core = extract_strong_core_mask(
        frame_rgbs[-1],
        latest_precip,
    )
